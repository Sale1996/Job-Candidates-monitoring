package com.intens.test.task.config;
...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("HR's API for monitoring job candidates")
				.description("Monitoring API reference for developers")
